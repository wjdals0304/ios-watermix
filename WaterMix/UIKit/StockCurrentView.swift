//
//  StockCurrentView.swift
//  WaterMix
//
//  Created by 김정민 on 2022/06/05.
//
...
final class StockCurrentView: BaseUIView {
    ...
    let stockMarketPriceField: AkiraTextField = {
    ...
    init(title: String,stockMarketPrice: String ,stockPriceText: String, sotckAmountText: String, totalPriceText: String) {
        self.titleLabel.text = title
        self.stockMarketPriceField.placeholder = stockMarketPrice
    ...
    override func setupConstraints() {
        ...
        stockMarketPriceField.snp.makeConstraints { make in
        ...
        stockPriceTextField.snp.makeConstraints { make in
            make.top.equalTo(stockMarketPriceField.snp.bottom).offset(12)
            make.leading.equalTo(lineView.snp.leading)
            make.trailing.equalTo(lineView.snp.trailing)
            make.height.equalTo(48)
        }
